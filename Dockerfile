...
RUN apt-get update \
    ...
    && apt-get update \
    && buildDeps='build-essential libcurl4-openssl-dev libexpat1-dev openssh-server libncurses-dev libssl-dev libxml2-dev autoconf git cmake csh ksh vim file curl wget texinfo flex bison gcc-6 gfortran-6 g++-6 ' \ 
